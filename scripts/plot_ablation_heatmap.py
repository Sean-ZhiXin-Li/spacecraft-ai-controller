...
# Generate a 2D heatmap: x=thrust_newton, y=difficulty_tag, color=final_radius_error.
# Works even if the grid is sparse (e.g., only 1 point).
# Output: analysis/figs/whpl06_thrust_x_difficulty_heatmap.png
...
def main() -> None:
    ...
    out_path = out_dir / "whpl06_thrust_x_difficulty_heatmap.png"
    ...
    ax.set_title("WHPL_06: thrust × difficulty heatmap (color=final_radius_error)")
