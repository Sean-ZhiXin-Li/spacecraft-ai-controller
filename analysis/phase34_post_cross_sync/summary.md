...
| Controller/mode | Cases | Crossings | Recoverable states | Recoverable crossings | CAPTURE label | LOCK label | Simulator success label | Mean crossing sync | Crossing-case best sync | Crossing-case best distance | Finite-row best distance | Overspeed |
|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
...
- CAPTURE, LOCK, and simulator success are state-machine/result labels in this 2D sandbox, not real flight-validation states.
